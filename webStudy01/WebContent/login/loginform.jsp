...
%>
	...
	<form name="loginForm"
		action="<%=request.getContextPath()%>/login/loginCheck.do"
		method="post">
		<%--
		String failId = request.getParameter("mem_id");
	--%>
		<ul>
			<li>아이디 : <input required data-msg-required="필수 데이터" type="text"
				name="mem_id" value="${failId }" />
			</li>
			<li>비밀번호 : <input required data-msg-pattern="형식확인" type="text"
				name="mem_pass" /> <input type="submit" value="로그인" />
			</li>
		</ul>
	</form>
	<script type="text/javascript">
